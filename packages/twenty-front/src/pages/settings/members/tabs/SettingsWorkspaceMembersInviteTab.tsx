...
export const SettingsWorkspaceMembersInviteTab = () => {
  ...
  return (
    <>
      {/* Este tab consume useSettingsAllRoles(), que lee de un estado en
          memoria. Sin montar el effect que lo puebla, entrar directo acá deja
          la lista vacía y el selector de rol aparece deshabilitado. */}
